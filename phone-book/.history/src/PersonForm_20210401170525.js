  ...
  return (
    ...
    <form onSubmit={addNewName}  className={classes.root} noValidate autoComplete="off">
      ...
      {/* calls the function tracking values in the name input */}
        ...
        <TextField xs={2} id="outlined-basic" label="Name" value={newName} onChange={handleNameChange} variant="outlined"/>

       {/* calls the function tracking values in the number input */}
        <TextField xs={2} id="outlined-basic" value={newNumber} onChange={handleNumberChange} label="Number" value={newName} variant="outlined"/>
